$(document).ready(function() {
    ...
    let link1 = '7/Хотите спросить о старике, с которым путешествуете?Хотите и дальше следовать за ним?';
    let link2 = '233/Хотите спросить о Кощеевой Цепи?';
    let link3 = '91/Хотите спросить о лучшей дороге к замку князя Кощея?';
    let link4 = '6/Хотите спросить, в какое время дня удобнее войти в усыпальницу?';
    let link5 = '92/Хотите спросить, что вам пригодится для успешного выполнения вашей миссии?';
    let enemyHealth = '2';
    let pageWin = 146;
    let pageLoose = 13;
    ...
    let enemy0 = "1/Очки от 7 до 12: Вы убили одного Волка";
