$(document).ready(function() {
    ...
    let bufHealth= 22;
    let minHealth = 0;
    let enemyStatus = "game";
    let pageContent = "Хозяин принимает у вас деньги и бросает на грязный стол костяной кубик, используемый в местной азартной игре. Окончательный результат подсчитывается, когда каждый бросит его по два раза";
    let pageSubs = "<a id='moneyagain' class='content__navigation'>Сделать ставку (2 гр)</a>";
    let enemyName = "ИГРА В КОСТИ";
    let enemyHealth = '2';
    let pageWin = 146;
    let pageLoose = 13;
