$(document).ready(function() {
    ...
    let pageContent = "Вы бросаете вазу на каменный пол, она разбивается.<br>Вы мчитесь к моментально захлопнувшейся двери.<br>Бросьте кость два раза, пытаясь уменьшить или уравнять очки с вашей Ловкостью.";
